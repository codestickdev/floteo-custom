...
<section class="carpageSlider" parent="<?php echo $postID; ?>">
	<div class="carpageSlider__contentWrap container-lg">
		<div class="carpageSlider__title container-lg">
			<h1><?php the_title(); ?></h1>
		</div>
		<?php
			$featured_post = get_field('best_offer', $postID);
			if( $featured_post ):

			$bestOfferID = $featured_post->ID;
		?>
			<a href="<?php the_permalink($bestOfferID); ?>" target="_blank" class="carpageBestoffer">
				<div class="info">
					<p>Najlepsza oferta w tym segmencie</p>
				</div>
				<div class="image">
					<img src="<?php echo get_the_post_thumbnail_url($bestOfferID); ?>"/>
				</div>
				<div class="content">
					<h3><?php echo get_the_title($bestOfferID); ?></h3>
					<p class="price"><?php the_field('domyslna_wycena_kwota', $bestOfferID); ?> <span>PLN/msc</span></p>
				</div>
			</a>
		<?php endif; ?>
...
<?php
	$carInfo = new WP_Query( $args );
	if( $carInfo->have_posts() ):
?>
<section class="carpageContent container-lg">
	<div class="carpageContent__wrapper">
		<div class="carpageContent__cover"></div>
		<?php while( $carInfo->have_posts() ) : $carInfo->the_post(); ?>
		<div class="carpageContent__content" spec-data="car_<?php echo get_the_ID(); ?>">
			<?php if(get_field('wyposazenie_dodatkowe')): ?>
			<div class="carpageWyposazenie">
				<div class="carpageWyposazenie__heading">
					<h2>Wyposazenie dodatkowe</h2>
				</div>
				<div class="carpageWyposazenie__content">
					<ul>
						<?php while(have_rows('wyposazenie_dodatkowe')): the_row();
							$opcja = get_sub_field('wyposazenie_dodatkowe_opcja');
						?>
						<li><?php echo $opcja; ?></li>
						<?php endwhile; ?>
					</ul>
				</div>
			</div>
			<?php endif; ?>
			<?php if(get_field('wyposazenie_podstawowe')): ?>
			<div class="carpageWyposazenie">
				<div class="carpageWyposazenie__heading">
					<h2>Wyposazenie podstawowe</h2>
				</div>
				<div class="carpageWyposazenie__content">
					<ul>
						<?php while(have_rows('wyposazenie_podstawowe')): the_row();
							$opcja = get_sub_field('wyposazenie_podstawowe_opcja');
						?>
						<li><?php echo $opcja; ?></li>
						<?php endwhile; ?>
					</ul>
			...
			<?php endif; ?>
			<?php if(get_field('dane_techniczne_pelna_specyfikacja_pdf')): ?>
			<div class="carpageSpecinfo">
				<div class="carpageSpecinfo__wrap">
					<div class="image"></div>
					<h3>Pobierz pełną specyfikację</h3>
					<a href="<?php the_field('dane_techniczne_pelna_specyfikacja_pdf'); ?>" target="_blank">Pobierz</a>
				</div>
			</div>
			<?php endif; ?>
			<div class="carpageSizes">
				<div class="carpageSizes__heading">
					<h2>Wymiary</h2>
				</div>
				<div class="carpageSizes__wrap">
					<div class="carpageSizes__sizes">
						<div class="image">
							<svg viewBox="0 0 1540.1 1299" class="dimensions__images --abe">
								<path fill="#353D61" d="M684.5,471c102,0,229.6,18.3,312.8,85.1h87.8c0,0,1.2-0.2,3.2-0.2c8.2,0,29.4,4,34.8,44.2
									...
									L684.5,441z"></path>
								<circle fill="#FFF" stroke="#353d61" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="215.4" cy="752.7" r="80.1"></circle>
								<circle fill="#FFF" stroke="#353d61" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="900.1" cy="752.7" r="80.1"></circle>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="5.6" y1="287.8" x2="1178.5" y2="287.8"></line>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="1055.8" y1="618.7" x2="1354" y2="618.7"></line>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="1180.5" y1="233.8" x2="1180.5" y2="337.8"></line>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="7.7" y1="227.1" x2="7.7" y2="344.6"></line>
								<path fill="#00D198" d="M598.1,163h-62.8l-10.4,30.1h-33.2l56.7-158h36.8l56.7,158h-33.4L598.1,163z M566.7,71.7l-22.8,66h45.6
									L566.7,71.7z"></path>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="212.4" y1="947.8" x2="898.9" y2="947.8"></line>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="900.1" y1="893.8" x2="900.1" y2="997.8"></line>
								<line fill="none" stroke="#CCCED6" stroke-width="10" stroke-miterlimit="10" x1="213.6" y1="887.1" x2="213.6" y2="1004.6"></line>
								<path fill="#00D198" d="M589.5,1165h-68v-157.7h65.1c33,0,51.3,17.2,51.3,40.7c0,19.2-11.5,31.2-26.9,36.2
									...
									C609.3,1104.9,599.6,1096.7,584.3,1096.7z"></path>
								<path fill="#00D198" d="M1505.8,564.2H1446v39.5h53.1v25.1H1446v41.8h59.9v25.8h-91.5v-158h91.5V564.2z"></path>
								<circle fill="CCCED6" cx="1055.8" cy="618.7" r="30.5"></circle>
								<path fill="none" stroke="#353d61" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M510.4,588.2c0,0,196,0,298-13.9"></path>
							</svg>
						</div>
						<div class="content">
							<p><span>A:</span> długość <span class="value"><?php the_field('wymiary_a'); ?></span></p>
							<p><span>B:</span> rozstaw osi <span class="value"><?php the_field('wymiary_b'); ?></span></p>
							<p><span>E:</span> bagażnik <span class="value"><?php the_field('wymiary_e'); ?></span></p>
						</div>
					</div>
					<div class="carpageSizes__sizes">
						<div class="image">
							<svg viewBox="0 0 1336.4 1034.7" class="dimensions__images --cd">
								<line fill="none" stroke="#ccced6" stroke-width="10" stroke-miterlimit="10" x1="259.9" y1="430.9" x2="259.9" y2="886.2"></line>
								<line fill="none" stroke="#ccced6" stroke-width="10" stroke-miterlimit="10" x1="314.1" y1="430.9" x2="196.6" y2="430.9"></line>
								<line fill="none" stroke="#ccced6" stroke-width="10" stroke-miterlimit="10" x1="314.1" y1="886.2" x2="196.6" y2="886.2"></line>
								<line fill="none" stroke="#ccced6" stroke-width="10" stroke-miterlimit="10" x1="460" y1="286.9" x2="1100.8" y2="286.9"></line>
								<line fill="none" stroke="#ccced6" stroke-width="10" stroke-miterlimit="10" x1="1102" y1="232.9" x2="1102" y2="336.9"></line>
								<line fill="none" stroke="#ccced6" stroke-width="10" stroke-miterlimit="10" x1="462.1" y1="226.2" x2="462.1" y2="343.7"></line>
								<rect fill="none" x="708.2" y="25" width="628.2" height="183.9"></rect>
								<path fill="#00d198" d="M796.1,32.4c35,0,63.5,18.8,74.1,51.1h-36.4c-7.5-15.1-21-22.6-38-22.6c-27.6,0-47.2,20.1-47.2,52.2
									...
									C716.1,65.9,750.6,32.4,796.1,32.4z"></path>
								<rect fill="none" y="560.1" width="196.6" height="474.5"></rect>
								<path fill="#00d198" d="M153.9,648.7c0,47.7-32.8,78.6-83.2,78.6H15.6V569.6h55.1C121.1,569.6,153.9,600.8,153.9,648.7z M69.6,700.5
									c33.2,0,52-19,52-51.7c0-32.8-18.8-52.4-52-52.4H47.2v104.2H69.6z"></path>
								<path fill="none" stroke="#353d61" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1099.5,574.6c-15.1-32.9-67.9-6.9-67.9-6.9l-31.5-66.8c-30.3-53.2-191-51.4-205.4-51.7l0,0c0,0-0.4,0-0.9,0
									...
									c0-22.1-6.7-40.7-6.7-40.7l-17.1-29.6C1115.7,607,1099.5,574.6,1099.5,574.6z"></path>
								<path fill="none" stroke="#353d61" stroke-width="30" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M609.4,588.3c0,0,145.8,16.7,354.1,0"></path>
							</svg>
						</div>
						<div class="content">
							<p><span>C:</span> długość <span class="value"><?php the_field('wymiary_c'); ?></span></p>
							<p><span>D:</span> wysokość <span class="value"><?php the_field('wymiary_d'); ?></span></p>
						</div>
					</div>
				</div>
			</div>
			<?php 
			$images = get_field('vehicle_photos');
			$size = 'full'; // (thumbnail, medium, large, full or custom size);
			if( $images ): ?>
			<div class="carpageGallery">
				<div class="carpageGallery__heading">
					<h2>Galeria</h2>
				</div>
				<div class="carpageGallery__wrap">
					<?php foreach( $images as $image_id ): ?>
						<div class="carpageGallery__image">
			...
			<?php endif; ?>
			<div class="carpageSpecial">
				<div class="carpageSpecial__wrap">
					<div class="info">
					...
					<div class="specs">
						<ul>
						<?php while(have_rows('na_abonament_options')): the_row();
							$pos = get_sub_field('na_abonament_options_option');
						?>
							<li><?php echo $pos; ?></li>
						<?php endwhile; ?>
						</ul>
					...
					<div class="link">
						<a href="<?php echo get_permalink(19); ?>#subject:<?php the_title(); ?>" target="_blank">Zapytaj o ofertę</a>
					</div>
				</div>
			</div>
		</div>
...
<section class="carpageRelated container-lg">
	<?php
	$count_cars	=	3;
	...
	?>
	<div class="carpageRelated__heading">
		<h2>Podobne oferty</h2>
	</div>
	<div class="carpageRelated__list" data-number="<?php echo $count; ?>">
		<?php $count = 0; ?>
		<?php while ($loop->have_posts()) : $loop->the_post();
			$count++;
		?>
		<a href="<?php the_permalink(); ?>" class="relatedTile" data-price-max="<?php the_field('cena_48msc_-_20%_-_20000') ?>" data-price-min="<?php the_field('cena_24msc_-_0%_-_40000') ?>" data-mark="<?php the_field('dane_techniczne_marka') ?>" data-body="<?php the_field('dane_techniczne_nadwozie') ?>" data-fuel="<?php echo get_field('dane_techniczne_paliwo')['value']; ?>" data-gearbox="<?php the_field('dane_techniczne_skrzynia_biegow') ?>">
			<div class="relatedTile__thumb">
				<img src="<?php the_post_thumbnail_url(); ?>"/>
			</div>
			<div class="relatedTile__content">
				<h3><?php the_title(); ?></h3>
				<div class="flags">
					<?php if (in_category('od-reki')) : ?><div class="flags__flag flags__flag--hand">Od ręki</div><?php endif; ?>
					<?php if (in_category('nowosc')) : ?><div class="flags__flag flags__flag--new">Nowe</div><?php endif; ?>
					<?php if (in_category('top')) : ?><div class="flags__flag flags__flag--top">Bestseller</div><?php endif; ?>
				</div>
			</div>
			<div class="relatedTile__info">
				<div class="content">
					<?php the_field('domyslna_oferta') ?>
				</div>
				<p class="price"><?php the_field('domyslna_wycena_kwota') ?> <span>PLN/msc</span></p>
			</div>
		</a>
		<?php endwhile; ?>
		<?php wp_reset_query(); ?>
...
<section class="carpageRelated carpageRelated--best container-lg">
	<?php
		$count_cars	=	3;
