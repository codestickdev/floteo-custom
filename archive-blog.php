					...
					<div class="blog__tile">
						...
						<div class="tile_header">
							<div class="tile_body" style="padding: 0px;">
								<a href="<?php the_permalink(); ?>"><h4 style="text-align:center;" title="<?php the_title(); ?>"><b style="    text-overflow: initial!important;overflow: inherit;!important; white-space: inherit!important;"><?php the_title(); ?></b></h4></a>
							</div>
